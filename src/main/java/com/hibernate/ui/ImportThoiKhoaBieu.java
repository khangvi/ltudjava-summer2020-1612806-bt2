...
public class ImportThoiKhoaBieu extends JDialog {
   
    private GiaoDienGiaoVu home;
    private final JPanel contentPanel = new JPanel();
    private JTextField txt_filepath;

    public ImportThoiKhoaBieu(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public void fun_btnOK() {
        ...
        if (filePath.equals(""))
            ...
            if (new HibernateUtil().importThoiKhoaBieu(filePath)) {       
                JOptionPane.showMessageDialog(rootPane, "Import thành công!");
                home.cbb_themMaMonHocVaoCBB();
                dispose();               
            } else
